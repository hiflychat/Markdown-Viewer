...
5. After feedback is attached, select its review icon and count—or the reviewed content itself—to open the saved item and a blank composer for adding more feedback to the same block.
