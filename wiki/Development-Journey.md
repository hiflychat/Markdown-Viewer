...
This page documents the development history, design decisions, and evolution of **Markdown Viewer** from its initial prototype to the current production release (v3.8.1).
...
+-----------------+------------------+
                  ...
                  v
+------------------------------------+
|  Phase 4: Release & Desktop (V3.8.1)|
...
| Target Area | Initial Prototype (Original V0.1) | Current Production Release (v3.8.1) |
| :--- | :--- | :--- |
